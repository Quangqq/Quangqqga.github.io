...
<br>
<a href='https://t.me/crowmatacc'><img height=100px width=100px src='https://i.imgur.com/b2lU0vL.jpg'/>
<br>
<br>
<font color="#00FFCC">ANTI DDOS BY:<font color="#FFCCCC"> Huỳnh Quang </a></font></font><br /><br />
...
<script id="source" language="javascript" type="text/javascript">
    $(document).ready(function () {
        ...
        let layer7 = new Highcharts.Chart({
            ...
            title: {
                text: "HIT ==> http://huynhquangspam.publicvm.com/tools",
                style: {
            color: 'white',
...
<a href="http://Quangqqga.github.io" style="color: #FF3399; font-size: 44px; font-style: sans-serif"><ins><b>Nhấn Vào Đây</b></ins> </a>


</html>

<div id="jsi-flying-fish-container"></div><br><br>
<footer style="text-align: center; font-size: 40px; background-color: #272d47; color: white;">All rights reserved by Phạm Huỳnh Quang - © 2023<br></footer>`
